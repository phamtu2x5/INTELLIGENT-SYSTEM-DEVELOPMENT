...
\section{Kết quả Đánh giá Đối đầu 5 Mô hình Học máy}
Dữ liệu được phân chia theo tỷ lệ $80\%$ huấn luyện ($N=614$) và $20\%$ kiểm thử ($N=154$) bảo toàn tỷ lệ phân bố nhãn (\texttt{stratify=y}).
...
\midrule
\textbf{Baseline (Dummy)} & 64.94 & 0.00 & 0.00 & 0.0000 & 0.5000 \\
\textbf{Logistic Regression} & 70.78 & 60.00 & 50.00 & 0.5455 & 0.8130 \\
\textbf{K-Nearest Neighbors} & 71.43 & 60.42 & 53.70 & 0.5686 & 0.7980 \\
\textbf{Support Vector Machine} & 74.03 & 66.67 & 51.85 & 0.5833 & 0.7976 \\
\textbf{Random Forest} & 71.43 & 61.90 & 48.15 & 0.5417 & 0.8230 \\
...
\section{Kết quả Đánh giá Đối đầu 5 Mô hình Hồi quy}
...
\section{Phân tích Mức độ Đóng góp Đặc trưng (Feature Importance)}
