...
\small
\setlength{\tabcolsep}{4pt}
\begin{tabularx}{\textwidth}{lXXXp{3.2cm}}
\toprule
\textbf{Mô hình Học máy} & \textbf{Thô ($X_{\text{unscaled}}$)} & \textbf{Chuẩn hóa ($X_{\text{scaled}}$)} & \textbf{Kỹ nghệ ($X_{\text{engineered}}$)} & \textbf{Đặc tính Ranh giới Học} \\
\midrule
\textbf{K-NN ($k=5$)} & $67.53\%$ ($0.7120$) & $70.78\%$ ($0.7850$) & \textbf{71.43\% (0.7980)} & Nhạy cảm Khoảng cách \\
\textbf{SVM (RBF Kernel)} & $64.94\%$ ($0.5820$) & $73.38\%$ ($0.7910$) & \textbf{74.03\% (0.7976)} & Nhạy cảm Hình học Kernel \\
\textbf{Logistic Regression} & $70.13\%$ ($0.8090$) & $70.78\%$ ($0.8130$) & \textbf{70.78\% (0.8130)} & Ranh giới Tuyến tính Phẳng \\
\textbf{Random Forest} & $71.43\%$ ($0.8190$) & $71.43\%$ ($0.8190$) & \textbf{71.43\% (0.8230)} & Bất biến Thang đo (Tree) \\
