...
\begin{tcolorbox}[colback=blue!3!white, colframe=blue!75!black, title=\textbf{Kho lưu trữ Mã nguồn \& Jupyter Notebook Thực nghiệm}]
\small
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
    ...
    \item \textbf{Mã nguồn Notebook Hệ thống Chẩn đoán Tiểu đường:} \href{https://github.com/phamtu2x5/INTELLIGENT-SYSTEM-DEVELOPMENT/blob/main/src/Week%201/notebooks/01_diabetes_analysis.ipynb}{\texttt{01\_diabetes\_analysis.ipynb}}
    \item \textbf{Mã nguồn Notebook Hệ thống Định giá Bất động sản:} \href{https://github.com/phamtu2x5/INTELLIGENT-SYSTEM-DEVELOPMENT/blob/main/src/Week%202/house_price_prediction/notebooks/01_house_price_analysis.ipynb}{\texttt{01\_house\_price\_analysis.ipynb}}
\end{itemize}
\end{tcolorbox}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Mã nguồn Notebook Huấn luyện \& Thực nghiệm:} \href{https://github.com/phamtu2x5/INTELLIGENT-SYSTEM-DEVELOPMENT/blob/main/src/Week%201/notebooks/01_diabetes_analysis.ipynb}{\texttt{01\_diabetes\_analysis.ipynb}}
    \item \textbf{Nguồn gốc Dữ liệu trên Kaggle:} \href{https://www.kaggle.com/datasets/hasibur013/diabetes-dataset}{\texttt{Kaggle -- Diabetes Dataset (Hasibur)}}
...
\begin{itemize}[leftmargin=1.5em, itemsep=2pt]
    \item \textbf{Mã nguồn Notebook Huấn luyện \& Thực nghiệm:} \href{https://github.com/phamtu2x5/INTELLIGENT-SYSTEM-DEVELOPMENT/blob/main/src/Week%202/house_price_prediction/notebooks/01_house_price_analysis.ipynb}{\texttt{01\_house\_price\_analysis.ipynb}}
    \item \textbf{Nguồn gốc Dữ liệu trên Kaggle:} \href{https://www.kaggle.com/datasets/nguyentiennhan/vietnam-housing-dataset-2024}{\texttt{Kaggle -- Vietnam Housing Dataset 2024}}
