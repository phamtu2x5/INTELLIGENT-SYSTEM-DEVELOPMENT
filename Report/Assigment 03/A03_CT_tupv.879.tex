...
\begin{itemize}[leftmargin=1.5em, itemsep=3pt]
    ...
    \item \textbf{Tập dữ liệu chuẩn đoán y sinh Pima Indians Diabetes (Kaggle):}\\ \href{https://www.kaggle.com/datasets/hasibur013/diabetes-dataset}{\texttt{Kaggle -- Pima Indians Diabetes Dataset (768 Records)}}
\end{itemize}
...
\subsection[Mã hóa đích Bayes làm mượt chống rò rỉ]{Mã hóa đích Bayes làm mượt (Smooth Bayesian Target Encoding) chống rò rỉ}
...
Không gian đặc trưng được số hóa thông qua giải thuật \textbf{TF-IDF} (Term Frequency -- Inverse Document Frequency):
\begin{equation}
